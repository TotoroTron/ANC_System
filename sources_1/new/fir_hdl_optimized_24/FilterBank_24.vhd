-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\fir_filter_hdl_optimized_24\FilterBank_24.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FilterBank_24
-- Source Path: fir_filter_hdl_optimized_24/Subsystem_24/Discrete FIR Filter HDL Optimized 24/FilterBank_24
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF FilterBank_24 IS

  -- Component Declarations
  COMPONENT subFilter_24
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : subFilter_24
    USE ENTITY work.subFilter_24(rtl);
  ...
  SIGNAL Coeff_signed                     : vector_of_signed24(0 TO 23);  -- sfix24_En24 [24]
  SIGNAL coeffIn_signed                   : vector_of_signed24(0 TO 23);  -- sfix24_En24 [24]
  SIGNAL CoefReg1                         : vector_of_signed24(0 TO 23);  -- sfix24_En24 [24]
  SIGNAL dinReg2_0_re                     : signed(23 DOWNTO 0);  -- sfix24_En24
  SIGNAL CoefReg2                         : vector_of_signed24(0 TO 23);  -- sfix24_En24 [24]
  SIGNAL CoefReg2_1                       : vector_of_std_logic_vector24(0 TO 23);  -- ufix24 [24]
  SIGNAL dinReg2Vld                       : std_logic;
  SIGNAL dout_1_re                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL doutVld                          : std_logic;

BEGIN
  u_subFilter_24_1_re : subFilter_24
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dinReg2_0_re),  -- sfix24_En24
              coefIn => CoefReg2_1,  -- sfix24_En24 [24]
